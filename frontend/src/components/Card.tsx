...
const Card: React.FC<Card> = ({ title, description, imageUrl, weight, version, isSelected, onToggle }) => {
                ...
                <div className="relative p-6 bg-white border-2 border-indigo-500 rounded-lg hover:scale-105 transition duration-500">
                    ...
                    <div className="text-gray-700 body-font">
                        <div className="container px-5 py-10 mx-auto">
                            ...
                            <div className="flex flex-wrap -m-4 text-center gap-4 relative">
                                <div className="">
                                    <div className="border-2 border-gray-600  p-3 rounded-lg transform transition duration-500 hover:scale-110">
                                        ...
                                        <h2 className="title-font font-medium text-lg text-gray-900">{weight}</h2>
                                ...
                                <div>
                                    ...
                                    <div className="border-2 border-gray-600  p-3 rounded-lg transform transition duration-500 hover:scale-110">
                                        ...
                                        <h2 className="title-font font-medium text-lg text-gray-900">{version}</h2>
