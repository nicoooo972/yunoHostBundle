  ...
  return (
    <>
      ...
      {data.map((application, index) => (
        <div className='flex gap-10 w-1/2 mx-36 py-16 flex-wrap' key={index}>
          <div className='flex px-4 py-2 rounded-md shadow-lg bg-gray-50 items-center justify-between'>
