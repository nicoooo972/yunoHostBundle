...
export const bundlesData = [
    { nom: 'Chaîne éditoriale', description: 'Description de la carte 2' },
    { nom: 'Synchroniser ses données entre périphériques', description: 'Description de la carte 1', lien: '/Synchro' },
    { nom: 'Association / projet de groupe, usages collaboratifs', description: 'Description de la carte 3' },
    { nom: 'Monter un CHATONS', description: 'Description de la carte 4' },
    { nom: '“Nettoyer” son accès internet', description: 'Description de la carte 5' },
];
